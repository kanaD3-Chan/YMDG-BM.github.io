...
::: info 感谢
很荣幸本文能被Cr9flm1nd师傅采纳并编写进HelloCTF中！
:::

## 开始之前的碎碎念......

不得不承认的一点是：当下的计算机专业大环境确实正在变得愈发糟糕。在一定程度上，AI 或许首当其冲地恶化了大环境。过去的4年里，我们见证了开发模式的彻底重写，也见证了学习模式的大翻盘，更是见证了各行各业在 AI 飞速发展下的万般变化。甚至包括本博客也存在大量 AIGC 的内容。

我们还发现：人们似乎越来越普遍地认为：观看视频、拷打 AI 似乎比阅读文档（比如说本文）更加有性价比。似乎大家越来越不愿意花十分钟时间仔细阅读一篇文章，而是想着把链接丢给AI，让它帮忙自动总结。

而且，当面对纯外语文章时，很多人第一时间想到的不是打开浏览器自带的翻译插件，或是把文章复制粘贴给AI来翻译，而是直接点击右上角叉号去关掉页面。

但是，在 CTF，甚至是计算机科学的世界中，我们能获取到的中文视频教程内容量，其实远比不上通过阅读文档或者他人的博客（不论任何语言的）的内容量。AI总结的内容也未必完全符合作者本意，甚至完全不符合事实。

但令我们难过的是：越来越多的新手在刚入门时就被各种便捷的工具与 AI 带偏，却忽视了基础知识与概念的重要性。他们看到了一把梭工具的便捷，看到了 AI 的强大，看到了私底下 py 时花小钱办大事的便利。甚至，我们靠一把梭工具 + AI + 私下 py 拿了世界冠军。

**但是请问：我们从这场比赛中真正学到了什么？**

所以，在开始我们正式的征程前，我希望能够看到这篇文章的各位，不论是经验丰富的专家，还是茫然四顾的萌新，我们更希望你现在能够暂时放下 AI，放下什么都不懂，只想找视频学的心态。

在不懂就问 AI、看视频操作之前，先试着用自己的脑子想一想，先自己上网搜一搜。毕竟用自己的脑子并不消耗 token，上网搜东西找到的文章文档消耗的流量也远比看视频要少得多。我们只需要吃掉两根不拿拿就完全能够补回来刚刚思考时消耗的能量。
...
如果你阅读到这里还没有退出本页，那，我们开始吧。


# 提问的智慧—公式版
本文采用[《知识共享 署名-相同方式共享 4.0 国际》许可协议](https://creativecommons.org/licenses/by-sa/4.0/deed.zh)。简单理解：转载或改编本文时，必须保留原作者署名和原文链接，并且新作品必须采用同样的 CC BY-SA 协议发布。
...
我们承认现在的AI相当发达，带着我们的问题去问AI，很容易获得我们需要的答案。不过注意：AI生成的内容仅供参考。

同样以第一步的 Python 报错为例。我们可以把报错信息复制，或者截图给AI，问如何解决这个问题，一般AI会给出详细解决方案的。

不过注意：代码bug等强逻辑性的问题，我们依然不推荐使用一些过于弱智的 AI 来解决。

::: important 
AI 有时会“幻觉”，尤其对于冷门工具或新版变化。如果 AI 给的命令执行后报新的错误，请回到第一步，并考虑切换到第三步甚至第四步、第五步、第六步。
:::
...
## 读后...
虽然我们给的是一个顺序型的解决问题方案，但是你并没有必要非得生搬硬套这一个流程来解决问题。如果你的直觉告诉你选某个方法更好，那么就选它吧。不过，我们还是希望你可以把第六步当成实在没招了的解决办法。等以后别人问你问题时，或许你会感谢现在的自己，正在靠着阅读本文学到的解决问题的方法来解决自己的问题，并且记住了解决这个问题的方法，然后教给了问你问题的那个人。

当你没有依靠AI总结读到这里时，我们相信你现在具备了最基本的自救与自学能力，看到外语文章时不会退缩，且自学能力不错。希望你以后遇到任何问题时，都能想起来本文开头的碎碎念和六部曲。如果你准备好了，随时都可以切换到下一篇文章➡️[第一步......](./first-step)


::: tip Cr9flm1nd师傅——猫猫の碎碎念
或许你会觉得阅读文档太耗费时间，或许你会觉得学习 CTF 得到的收益远没有 AI 一把梭高。
但是请记得： **生活并不只有 CTF，学到你手里的技术，别人抢都抢不走。**
不得不承认，Vibe coding 确实有效提升了我们的效率，mcp 工具和 Agent、 Openclaw skill 的介入确实提高了你的成绩。
但是，比赛之外呢？

**仅靠外力得来的力量，终究不属于你。**
极客们追求的“学习版”，“绿色版”，挖洞渗透的整体逻辑和方向把控，安全算法的研发与验证……
这些东西，只靠 AI 工具确实很难实现啊……

退一万步讲，即便你选择了人机协同的路线，也只有当你自身真正掌握时，AI 才能发挥出更高的水平。
否则，你只会成为 AI 的“累赘”：看不懂 AI 卡死在哪里，不知道怎么给予 AI 方向。
你能做的只是在电脑面前，盯着 AI 工具不断弹出各种尝试步骤，不断燃烧本属于你的资源，每次发送prompt，每次点击那个重试按钮，都像摇老虎机一样......
**只是祈求 AI 能跑出正确的结果。**
